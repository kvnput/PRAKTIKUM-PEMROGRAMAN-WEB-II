    ...
    <div class="row">             
        <div class="col-md-12 py-3">                 
            ...
            <h3>Daftar Buku</h3></br>                 
                ...
                <a class="btn btn-secondary my-1" href='FormBuku.php' style="float: right;"><i class="fa fa-book"></i> Tambah Data</a>
            <table class="table table-striped">             
                ...
                <tbody>                 
                    ...
                    <tr>                     
                        ...
                        <td>                     
                            <a href="FormBuku.php?id_buku=<?= $row['id_buku']; ?>" class='btn btn-primary btn-sm ml-2'><i class="fa fa-pencil"></i>Edit</a>
